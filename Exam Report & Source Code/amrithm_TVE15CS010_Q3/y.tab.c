...
static const char *const yytname[] =
{
  ...
  "$accept", "prog", "expression", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 3:
#line 42 "conv.y" /* yacc.c:1646  */
    { (yyval.val) = (yyvsp[-2].val) + (yyvsp[0].val); printf("+");}
#line 1213 "y.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 43 "conv.y" /* yacc.c:1646  */
    { (yyval.val) = (yyvsp[-2].val) * (yyvsp[0].val); printf("*");}
#line 1219 "y.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 44 "conv.y" /* yacc.c:1646  */
    { (yyval.val) = (yyvsp[-2].val) - (yyvsp[0].val); printf("-");}
#line 1225 "y.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 45 "conv.y" /* yacc.c:1646  */
    { (yyval.val) = (yyvsp[-2].val) / (yyvsp[0].val); printf("/");}
#line 1231 "y.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 46 "conv.y" /* yacc.c:1646  */
    {   printf("%s",(yyvsp[0].name)); }
#line 1237 "y.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 47 "conv.y" /* yacc.c:1646  */
